...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body " style="background-color: #ffffff;">
    ...
    <a href="toadd" class="layui-btn "><i class="layui-icon">&#xe608;</i> 新增员工</a>
		<table class="layui-table">
		  ...
		  <c:forEach var="em" items="${elist}" varStatus="status">
		    <tr>
			  ...
			  <td>${em.bonus}</td>
			  <td>
						<a  class="layui-btn" href="edit?eid=${em.eid}">修改</a>
					    <a  class="layui-btn layui-btn-danger" href="delete?eid=${em.eid}">删除</a>
			  </td>
		    </tr>
		    </c:forEach>
		  </tbody>
