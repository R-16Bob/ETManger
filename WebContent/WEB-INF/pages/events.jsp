...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body " style="background-color: #ffffff;">
    ...
    <div style="padding: 15px;">
        <a href="toadd" class="layui-btn "><i class="layui-icon">&#xe608;</i> 新增收支项</a>
		<table class="layui-table">
		  ...
		  <c:forEach var="event" items="${elist}" varStatus="status">
		    <tr>
			  ...
			  <td>
			  <a  class="layui-btn" href="edit?id=${event.id}">修改</a>
			  <a  class="layui-btn layui-btn-danger" href="delete?id=${event.id}">删除</a>
			  </td>
		    </tr>
		    </c:forEach>
		  </tbody>
